  ...
  return (
    <div className="landing-page">
        ...
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <p className="description">
              We create life-changing learning experiences, by helping people find the magic of the best tutors.
            </p>
            <p className="description">
              A personalized journey, and the motivation that helps people learn and keep learning.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="services-section">
        <h2>Find your next hire for a short task or long-term growth</h2>
      ...
      <section className="team-section">
        ...
        <p className="team-subtitle">
          Clarify gives you the blocks & components you need to create a truly professional website, landing page or admin panel for your SaaS.
        </p>
